...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleSettings = [{id:"small", num:0, fromX:0, toX:this.totalWidth, ballwidth:3, alphamax:0.6, areaHeight:.5, color:"#FFFFFF", fill:false}, 
								{id:"medium", num:250, fromX:0, toX:this.totalWidth,  ballwidth:3, alphamax:0.5, areaHeight:3, color:"#FFFFFF", fill:true}, 
								{id:"large", num:0, fromX:0, toX:this.totalWidth, ballwidth:30,  alphamax:0.4, areaHeight:1, color:"#FFFFFF", fill:true}];
		this.particleArray = [];
		this.lights = [{ellipseWidth:300, ellipseHeight:300, alpha:0.05, offsetX:0, offsetY:0, color:"#FFFFFF"}, 
						{ellipseWidth:250, ellipseHeight:250, alpha:0.05, offsetX:0, offsetY:0, color:"#FFFFFF"}, 
						{ellipseWidth:100, ellipseHeight:100, alpha:0.05, offsetX:0, offsetY:0, color:"#FFFFFF"}];
